...
.divTableBody { display: table-row-group;}
    ...
    if len(propertiesDescriptions) > 1:
        ...
        html += rowDivStart + "<h2>" + "Definition" + "</h2>" + str(propertiesDescriptions[0]) + "<br>" + msg + "<br>" + rowDivEnd
    ...
    if len(dataTypesUsed) > 1:
        ...
        html += rowDivStart + "<h3>" + "Data Types" + "</h3> " + str(dataTypesUsed[0]) + "<br>" + msg + "<br>" + rowDivEnd
    ...
    for dm, subject in sorted(dataModelsUsed, key=lambda x: x[1]):
        dataModelsString += "<a href=" + chr(34) + rootSmartDataModels + subject + "/tree/master/" + dm + chr(34) + ">" + dm + "</a><br>"
        page["dataModelsUsingProperty"][dm] = "[" + rootSmartDataModels + subject + "/tree/master/" + dm + "](" + dm + ")"
    ...
    if len(dataTypesNGSIUsed) > 0:
        ...
        html += rowDivStart + "<h3>" + "NGSI type of the term in this subject" + "</h3> " + "<br>".join(dataTypesNGSIUsed) + rowDivEnd
    ...
    if len(modelDescriptions) > 0:
        ...
        html += rowDivStart + "<h3>" + "Models of the term in this subject" + "</h3> " + "<br>".join(modelDescriptions) + rowDivEnd
    ...
    if len(unitsDescriptions) > 0:
        ...
        html += rowDivStart + "<h3>" + "Units of the term in this subject" + "</h3> " + "<br>".join(unitsDescriptions) + rowDivEnd
