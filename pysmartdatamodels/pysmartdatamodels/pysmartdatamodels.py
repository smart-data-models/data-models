...
from .utils import extract_subject_from_raw_url, extract_datamodel_from_raw_url, \
                    open_jsonref, parse_property2ngsild_example, normalized2keyvalues_v2, create_context, \
                    generate_random_string, is_metadata_properly_reported, is_metadata_existed, \
                    schema_output_sum, message_after_check_schema, open_yaml, is_url_existed, \
                    parse_payload_v2, parse_yamlDict
...
returnPendingMessage = "====== Examples are unable to be generated for the model ====== \nThe current schema may includes open attributes that need futher definition, like subproperties inside of object strucutre, or other inner problems, like infinite recursion and unknown format."
