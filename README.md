...
- FIWARE foundation and TMForum will check for the consitency and updating of the different
data models in this group of repositories

- It is possible to request a [new data model](http://data-models.fiware.org/index.php/expert_data_modeler/) through the link. 
